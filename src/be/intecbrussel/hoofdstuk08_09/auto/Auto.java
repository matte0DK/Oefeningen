package be.intecbrussel.hoofdstuk08_09.auto;
...
//    }
    ...
    private Auto() {
        this((int) Auto.myRandomSpeed(), Auto.myRandomHorsepower(), Auto.myRandomColor(), Auto.myRandomLight());
    }
    ...
    public static double myRandomSpeed() {
